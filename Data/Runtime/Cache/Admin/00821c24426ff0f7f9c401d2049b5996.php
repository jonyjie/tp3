        ...
        <div class="col-md-12 graphs">
	     ...
	     <div class="bs-example4" data-example-id="contextual-table">
  	       <ul class="nav nav-tabs" role="tablist" id="nav_tabs">
            	<li class="active"><a href="<?php echo U('Setting/userinfo');?>">修改用户信息</a></li>
            	<li><a href="<?php echo U('Setting/passowrd');?>">修改密码</a></li>
    		</ul>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="<?php echo U('Menu/passowrd_post');?>" method="post" 	="">
				                ...
				                <div class="form-group text-center">
				                  ...
				                  <a class="btn btn-default btn-sm col-xs-2  col-xs-offset-1" href="<?php echo U('Index/index');?>" >返回</a>
				                </div>
