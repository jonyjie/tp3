...
<script type="text/javascript" src="/Public/Admin/js/jquery.treetable-ajax-persist.js"></script>
<script type="text/javascript" src="/Public/Admin/js/jquery.treetable-3.0.0.js"></script>
<script type="text/javascript" src="/Public/Admin/js/persist-min.js"></script>
<link href="/Public/Admin/css/jquery.treetable.css" media="all" rel="stylesheet" type="text/css" />
...
<div class="col-md-12 graphs">
    ...
    <form action="<?php echo U('AuthManager/authrize_post');?>" method="post">
    ...
    <table class="table table-striped">
      ...
      <div class="form-group text-center">
          ...
          <a class="btn btn-default btn-sm col-xs-2  col-xs-offset-1" href="<?php echo U('AuthManager/index');?>" >返回</a>
      </div>
    </form>
   </div>
