...
<div id="wrapper">
    ...
    <a href="<?php echo U('Auth/addNode');?>"  role="button" class="btn btn-info btn-lg"> 添加节点</a> 
    <a href=""  role="button" class="btn btn-info btn-lg">删除节点</a>
    <table class="table table-striped">
      ...
      <tbody>
      <?php if(is_array($nodelist)): $ids = 0; $__LIST__ = $nodelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($ids % 2 );++$ids;?><tr>
          ...
          <td>
            <a href="<?php echo U('Auth/editNode',array('id'=>$vo['id']));?>" role="button" class="btn btn-warning btn-xs">编辑</a>
            <a href="<?php echo U('Auth/distrNode',array('id'=>$vo['id']));?>" role="button" class="btn btn-info btn-xs">禁用</a>
            <a href="<?php echo U('Auth/delNode',array('id'=>$vo['id']));?>" role="button" class="btn btn-success btn-xs">删除</a>
          </td>
