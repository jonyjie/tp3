...
<div class="col-md-12 graphs">
    ...
    <ul class="nav nav-tabs" role="tablist" id="nav_tabs">
            <li class="active"><a href="<?php echo U('AuthManager/index');?>">角色中心</a></li>
            <li ><a href="<?php echo U('AuthManager/roleadd');?>">添加角色</a></li>
    </ul>
    <table class="table table-striped">
      ...
      <tbody>
      <?php if(is_array($Glist)): $ids = 0; $__LIST__ = $Glist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($ids % 2 );++$ids;?><tr>
          ...
          <td>
            <a href="<?php echo U('AuthManager/authrize?id='.$vo['id']);?>" role="button" class="btn btn-warning btn-xs">访问授权</a>
            <a href="<?php echo U('AuthManager/roleedit',array('id'=>$vo['id']));?>" role="button" class="btn btn-warning btn-xs">编辑</a>          
            <a href="<?php echo U('AuthManager/roledelete?id='.$vo['id']);?>" role="button" class="btn btn-success btn-xs">删除</a>
          </td>
