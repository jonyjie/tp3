...
<div id="wrapper">
	...
	<div id="page-wrapper">
        ...
        <div class="graphs">
	     <div class="xs">
  	       <h3>Forms  <a href="javascript:load(-1);" class="glyphicon glyphicon-share-alt glyphicon-info glyphicon-sm" style="float: right;">返回</a> </h3>
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" placeholder="后台控制" name="title">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" placeholder="Admin/Index/index" name="name">
									</div>
									<div class="col-sm-2" style="display: none;">
										<p class="help-block">Your help text!</p>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<div class="radio-inline"><label><input type="radio" name="status" checked="checked" value="1"> 启用</label></div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="focusedinput" placeholder="" name="condition">
									</div>
									<div class="col-sm-2" style="display: none;">
										<p class="help-block">Your help text!</p>
									</div>
