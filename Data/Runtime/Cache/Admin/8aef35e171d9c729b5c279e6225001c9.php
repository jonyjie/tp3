        ...
        <div class="col-md-12 graphs">
	     ...
	     <div class="bs-example4" data-example-id="contextual-table">
  	       <ul class="nav nav-tabs" role="tablist" id="nav_tabs">
            	<li ><a href="<?php echo U('AuthManager/index');?>">角色中心</a></li>
            	<li class="active"><a href="<?php echo U('AuthManager/roleadd');?>">添加角色</a></li>
    		</ul>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="<?php echo U('AuthManager/roleadd_post');?>" method="post" 	="">                
				                <div class="form-group">
				                  <label for="focusedinput" class="col-sm-2 control-label">角色名</label>
				                  <div class="col-sm-8">
				                    <input type="text" class="form-control1" id="focusedinput" placeholder="uer" name="title" value="">
				                  </div>
				                ...
				                <div class="form-group">
				                  ...
				                  <div class="col-sm-8">
				                    <textarea name="remark" rows="2" cols="20" class="form-control1 col-sm-12"></textarea>
				                  </div>
				                  <div class="col-sm-2" style="display: none;">
				                    <p class="help-block">Your help text!</p>
				                  </div>
