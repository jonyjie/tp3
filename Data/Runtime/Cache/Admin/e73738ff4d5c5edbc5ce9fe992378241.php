	          ...
	          <li class="active"><a href="">添加管理员</a></li>
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="<?php echo U('User/add_post');?>" method="post">                
				                <div class="form-group">
				                  <label for="focusedinput" class="col-sm-2 control-label">用户名</label>
				                  <div class="col-sm-8">
				                    <input type="text" class="form-control1" id="focusedinput" placeholder="uer" name="username" value="">
				                  </div>
				                ...
				                <div class="form-group">
				                  ...
				                  <div class="col-sm-8">
				                    <input type="password" class="form-control1" id="focusedinput" placeholder="密码" name="password" value="">
				                  </div>
				                  <div class="col-sm-2" style="display: none;">
				                    <p class="help-block">Your help text!</p>
				                  </div>
				                ...
				                <div class="form-group">
				                  ...
				                  <div class="col-sm-8">
				                    <input type="email" class="form-control1" id="focusedinput" placeholder="email@qq.com" name="email" value="">
				                  </div>
				                  <div class="col-sm-2" style="display: none;">
				                    <p class="help-block">Your help text!</p>
				                  </div>
				                ...
				                <div class="form-group">
				                  ...
				                  <div class="col-sm-8">
				                    <?php if(is_array($Glist)): $i = 0; $__LIST__ = $Glist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><label class="checkbox-inline"><input type="checkbox" name="group[]" value="<?php echo ($vos["id"]); ?>"><?php echo ($vos["title"]); ?></label><?php endforeach; endif; else: echo "" ;endif; ?>
