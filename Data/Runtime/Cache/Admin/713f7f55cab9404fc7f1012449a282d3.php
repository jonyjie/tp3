	          ...
	          <li class="active"><a href="">添加管理员</a></li>
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="<?php echo U('User/edit_post');?>" method="post">
								<input type="hidden" name="id" value="<?php echo ($user["id"]); ?>">              
				                <div class="form-group">
				                  <label for="focusedinput" class="col-sm-2 control-label">用户名</label>
				                  <div class="col-sm-8">
				                    <input type="text" class="form-control1" id="focusedinput" placeholder="uer" name="username" value="<?php echo ($user["username"]); ?>">
				                  </div>
				                ...
				                <div class="form-group">
				                  ...
				                  <div class="col-sm-8">
				                    <input type="password" class="form-control1" id="focusedinput" placeholder="**********" name="password" value="">
				                  </div>
				                  <div class="col-sm-2" style="display: none;">
				                    <p class="help-block">Your help text!</p>
				                  </div>
				                ...
				                <div class="form-group">
				                  ...
				                  <div class="col-sm-8">
				                    <input type="email" class="form-control1" id="focusedinput" placeholder="email@qq.com" name="email" value="<?php echo ($user["user_email"]); ?>">
				                  </div>
				                  <div class="col-sm-2" style="display: none;">
				                    <p class="help-block">Your help text!</p>
				                  </div>
				                ...
				                <div class="form-group">
				                  ...
				                  <div class="col-sm-8">
				                    ...
				                    <div class="radio-inline"><label><input type="radio" name="status" value="1" <?php if(($user["status"]) == "1"): ?>checked<?php endif; ?> > 启用</label></div>
				                    <div class="radio-inline"><label><input type="radio" name="status" value="0" <?php if(($user["status"]) == "0"): ?>checked<?php endif; ?>> 禁用</label></div>
				                    
				                  </div>
				                </div>
				                <div class="form-group">
				                  <label for="focusedinput" class="col-sm-2 control-label">管理组</label>
				                  <div class="col-sm-8">
				                    <?php if(is_array($glist)): $i = 0; $__LIST__ = $glist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?><label class="checkbox-inline"><input type="checkbox" name="group[]" value="<?php echo ($vos["id"]); ?>"  checked="<?php echo ($vos["checked"]); ?>" ><?php echo ($vos["title"]); ?></label><?php endforeach; endif; else: echo "" ;endif; ?>
				                ...
				                <div class="form-group text-center">
				                  ...
				                  <a class="btn btn-default btn-sm col-xs-2  col-xs-offset-1" href="<?php echo U('User/index');?>" >返回</a>
				                </div>
