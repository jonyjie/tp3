      ...
      <div class="col_1">
               ...
               <div class="activity_box">
                <div class="scrollbar" id="style-2">
                   <div class="activity-row">
                     ...
                     <div class="col-xs-3 activity-img"><img src='/Public/Admin/images//5.png' class="img-responsive" alt=""/></div>
            ...
            <div class="col-md-4 stats-info">
                <div class="panel-heading">
                    <h4 class="panel-title"><?php echo (L("SYSTEM_INFORMATIONS")); ?></h4>
                </div>
                <div class="panel-body">
                    <ul class="list-unstyled">
                    <?php if(is_array($infos)): $i = 0; $__LIST__ = $infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><?php echo ($key); ?><div class="text-success pull-right"><?php echo ($vo); ?></div></li><?php endforeach; endif; else: echo "" ;endif; ?>
...
var detail = new Rickshaw.Graph.HoverDetail({
    graph: graph
          ...
          <!-- map -->
<link href="/Public/Admin/css/jqvmap.css" rel='stylesheet' type='text/css' />
<script src="/Public/Admin/js/jquery.vmap.js"></script>
