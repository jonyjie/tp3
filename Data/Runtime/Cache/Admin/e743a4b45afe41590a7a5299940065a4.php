        ...
        <div class="col-md-12 graphs">
	     ...
	     <div class="bs-example4" data-example-id="contextual-table">
  	       <ul class="nav nav-tabs" role="tablist" id="nav_tabs">
            	<li ><a href="<?php echo U('Menu/index');?>">菜单中心</a></li>
            	<li ><a href="<?php echo U('Menu/add');?>">添加菜单</a></li>
    		</ul>
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="<?php echo U('Menu/edit_post');?>" method="post" >
								<input type="hidden" name="id" value="<?php echo ($menu["id"]); ?>" />
				                <div class="form-group">

				                  <label for="focusedinput" class="col-sm-2 control-label">菜单名称</label>
				                  <div class="col-sm-8">
				                    <input type="text" class="form-control1" id="focusedinput" placeholder="uer" name="name" value="<?php echo ($menu["name"]); ?>">
				                  </div>
				                ...
				                <div class="form-group">
				                  <label for="focusedinput" class="col-sm-2 control-label">上级菜单</label>
				                  <div class="col-sm-8">
				                    <select name="parentid" class="form-control1">
				                    	<?php echo ($menuslist); ?>
				                    </select>
				                  </div>
				                  <div class="col-sm-2" style="display: none;">
				                ...
				                <div class="form-group">
				                  <label for="focusedinput" class="col-sm-2 control-label">所在项目组</label>
				                  <div class="col-sm-8">
				                    <input type="text" class="form-control1" id="focusedinput" placeholder="app" name="app" value="<?php echo ($menu["app"]); ?>">
				                  </div>
				                  <div class="col-sm-2" style="display: none;">
				                    <p class="help-block">Your help text!</p>
				                  </div>
				                ...
				                <div class="form-group">
				                  ...
				                  <div class="col-sm-8">
				                    <input type="text" class="form-control1" id="focusedinput" placeholder="model" name="model" value="<?php echo ($menu["model"]); ?>">
				                  </div>
				                  <div class="col-sm-2" style="display: none;">
				                    <p class="help-block">Your help text!</p>
				                  </div>
				                ...
				                <div class="form-group">
				                  <label for="focusedinput" class="col-sm-2 control-label">行为名称</label>
				                  <div class="col-sm-8">
				                    <input type="text" class="form-control1" id="focusedinput" placeholder="uer" name="action" value="<?php echo ($menu["action"]); ?>">
				                  </div>
				                  <div class="col-sm-2" style="display: none;">
				                    <p class="help-block">Your help text!</p>
				                  </div>
				                ...
				                <div class="form-group">
				                  ...
				                  <div class="col-sm-8">
				                    <div class="radio-inline"><label><input type="radio" name="status" value="1" <?php if(($menu["status"]) == "1"): ?>checked<?php endif; ?>> 启用</label></div>
				                    <div class="radio-inline"><label><input type="radio" name="status" value="0"  <?php if(($menu["status"]) == "0"): ?>checked<?php endif; ?>> 禁用</label></div>				                    
				                  </div>
				                </div>
				                
				                <div class="form-group text-center">
				                  <input type="submit" class="btn btn-info btn-sm col-xs-2" value=" 提交 " />                  
				                  <a class="btn btn-default btn-sm col-xs-2  col-xs-offset-1" href="<?php echo U('Menu/index');?>" >返回</a>
				                </div>
