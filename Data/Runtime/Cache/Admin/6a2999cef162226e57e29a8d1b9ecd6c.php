	          ...
	          <li class="active"><a href="">添加管理员</a></li>
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="<?php echo U('AuthManager/roleedit_post');?>" method="post">
								<input type="hidden" name="id" value="<?php echo ($group["id"]); ?>">              
				                <div class="form-group">
				                  <label for="focusedinput" class="col-sm-2 control-label">角色名</label>
				                  <div class="col-sm-8">
				                    <input type="text" class="form-control1" id="focusedinput" placeholder="角色名称" name="title" value="<?php echo ($group["title"]); ?>">
				                  </div>
				                ...
				                <div class="form-group">
				                  <label for="focusedinput" class="col-sm-2 control-label">描述</label>
				                  <div class="col-sm-8">
				                    <textarea name="remark" rows="2" cols="20" class="form-control1 col-sm-12"><?php echo ($group["remark"]); ?></textarea>
				                  </div>
				                  <div class="col-sm-2" style="display: none;">
				                    <p class="help-block">Your help text!</p>
				                  </div>
				                ...
				                <div class="form-group">
				                  ...
				                  <div class="col-sm-8">
				                    ...
				                    <div class="radio-inline"><label><input type="radio" name="status" value="1" <?php if(($group["status"]) == "1"): ?>checked<?php endif; ?> > 启用</label></div>
				                    <div class="radio-inline"><label><input type="radio" name="status" value="0" <?php if(($group["status"]) == "0"): ?>checked<?php endif; ?>> 禁用</label></div>
